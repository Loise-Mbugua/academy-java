package com.bptn.course._13_treeSet;
...
public class TreeSetManipulation {
	public static void main(String[] args) {
		...
		// Use the first() method to get the first element in the set, then print it
		// out.
		...
		// Use the headSet() method to get the elements in the set that are strictly
		// less than the element B.
		System.out.println("Elements less than 'B': " + set.headSet("B"));

		// Use the tailSet() method to get the elements in the set that are greater than
		// or equal to B.
		...
		// equal to a lower bound and less than an upper bound.
		// In this case, the elements between A (inclusive) and C (exclusive).
